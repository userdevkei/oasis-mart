            ...
            <div class="add-product">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        {!! Form::text('name',$product->name,['class' => 'form-control col-md-12', 'placeholder' => 'product name']) !!}
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        $product->type,['class' => 'form-control col-md-12', 'placeholder' => '--select--' ]) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        $product->category,['class' => 'form-control col-md-12', 'placeholder' => '--select--' ]) !!}
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        'Mobile repairs' => 'Mobile repairs', 'CCTV installation' => 'CCTV installation'],$product->model,
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        {!! Form::text('b-price',$product->b_price,['class' => 'form-control col-md-12', 'placeholder' => 'Ksh. ']) !!}
                    </div>

                    <div class="col-md-4 form-group">
                        {!! Form::label('product-selling',('Selling Price'), ['class' => 'form-label col-md-6 text-left']) !!}
                        {!! Form::text('s-price',$product->s_price,['class' => 'form-control col-md-12', 'placeholder' => 'Ksh. ' ]) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        $product->status,['class' => 'form-control col-md-12', 'placeholder' => '--select--']) !!}
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        $product->availability,['class' => 'form-control col-md-12', 'placeholder' => '--select--' ]) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        {!! Form::textarea('description',$product->description,['class' => 'form-control col-md-12', 'rows' => '4',
