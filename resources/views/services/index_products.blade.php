    ...
    <section class="home">
            <div class="dashboard-left">
                <div class="dash-links">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a class="nav-link active" href="{{ url('/services') }}">
            ...
            <div class="dashboard-right">
                ...
                <div class="table-responsive-sm">
                    @if(count($service)>0)
                        <table class="table-sm table-striped table-borderless w-100 d-block d-md-table">
                            <thead>
                            <th>Name</th>
                            <th>Serial</th>
                            <th>Type</th>
                            ...
                            @foreach($service as $item)
                                <tr>
                                    ...
                                    <td nowrap="">
                                        <a class="btn btn-sm btn-info" title="view this service" href="{{ route('services.show', $item->id) }}"><i class="fa">@fas('eye')</i></a>
                                        <a class="btn btn-sm btn-info" title="edit this service" href="{{ route('services.edit', $item->id) }}"><i class="fa">@fas('pencil-alt')</i></a>
                               <a class="btn btn-sm btn-info" title="delete this service" href="#"><i class="fas">@fas('trash-alt')</i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
